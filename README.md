...
In this project I'll use the ["The Lakh MIDI Dataset v0.1."](https://colinraffel.com/projects/lmd/) I'll filtered the dataset leaving only songs that are tagged "Pop" or "Electronic."
