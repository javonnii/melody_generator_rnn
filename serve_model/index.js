const improvCheckpoint = "https://storage.googleapis.com/magentadata/js/checkpoints/music_rnn/melody_rnn"
...
const startProgram = async () => {
  try {
    ...
    let improvisedMelody = await improvRNN.continueSequence(quantizedSequence, 28.5, 1.1)
